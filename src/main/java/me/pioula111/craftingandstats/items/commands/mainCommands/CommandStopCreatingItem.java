...
public class CommandStopCreatingItem implements CommandExecutor {
    private ItemManager itemManager;

    public CommandStopCreatingItem(ItemManager itemManager) {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        player.sendMessage(Component.text().content("Pomyślnie przerwano robienie itemu!").style(Style.style(MenuHelper.MAIN_NAME)));
        return true;
    }
}
